...
while True:
    ...
    time.sleep(0.1)
time.sleep(1)
pyautogui.doubleClick(pyautogui.locateCenterOnScreen('Png/plity.png'))
while True:
     if pyautogui.locateOnScreen("Png/Filtr.png"):
        break
     time.sleep(0.1)
time.sleep(1)
pyautogui.doubleClick(pyautogui.locateCenterOnScreen('Png/Filtr.png'))
while True:
    if pyautogui.locateOnScreen("Png/Pack.png"):
        break
    time.sleep(0.1)
time.sleep(1)
pyautogui.doubleClick(pyautogui.locateCenterOnScreen('Png/Pack.png'))
while True:
    if pyautogui.locateOnScreen("Png/lupa.png"):
        break
    time.sleep(0.1)
time.sleep(1)
pyautogui.click(pyautogui.locateCenterOnScreen('Png/lupa.png'))
while True:
    time.sleep(1)
...
while True:
    if pyautogui.locateOnScreen("Png/zagruzka1.png"):
        break
    time.sleep(0.1)
pyautogui.click(pyautogui.locateCenterOnScreen('Png/zagruzka1.png'))
while True:
    if pyautogui.locateOnScreen("Png/zagruzka2.png"):
        break
    time.sleep(0.1)
pyautogui.click(pyautogui.locateCenterOnScreen('Png/zagruzka2.png'))
time.sleep(1)
...
while True:
    ...
    time.sleep(0.1)
try:
    pyautogui.click(pyautogui.locateCenterOnScreen('Png/SAP1.png'))
except:
    time.sleep(0.1)
...
if pyautogui.locateOnScreen("Png/SAP3.png"):
    try:
        pyautogui.click(pyautogui.locateCenterOnScreen('Png/SAP3.png'))
        time.sleep(0.1)
        pyautogui.press("enter")
    except:
        time.sleep(0.1)
...
while True:
    ...
    time.sleep(0.1)
try:
    pyautogui.click(pyautogui.locateCenterOnScreen('Png/SAP8.png'))
except:
    time.sleep(1)
time.sleep(0.1)
...
while True:
    ...
    time.sleep(0.1)
try:
    pyautogui.click(pyautogui.locateCenterOnScreen('Png/SAP9.png'))
except:
    time.sleep(0.1)
time.sleep(1)
...
for i in range(len(s)):
    ...
    pyautogui.press("enter")
    time.sleep(1.5)
pyautogui.write("-" + str(len(s)) + "ta bo'ldi. -")
pyautogui.press("enter")
